...
REAL shekel( REAL* x, int n ) {
    static const REAL a[30][10] =
	{
...
static REAL ShekelFoxholes( const vector<REAL>& x ) {
...
void eval( vector<REAL> x, int curr ) {
	...
	REAL f1 = shekel( &x[0], N );//how to use version 1
	REAL f2 = ShekelFoxholes( x ); //how to use version 2
